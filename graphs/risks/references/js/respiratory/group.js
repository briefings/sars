...
function generateChart(fileNamekey) {
    ...
    $.getJSON('https://raw.githubusercontent.com/briefings/sars/develop/explorations/toxicity/warehouse/graphing/respiratory/group/' + fileNamekey + '.json', function (risk) {
        ...
        Highcharts.chart('container0003', {
            ...
            yAxis: {
                ...
                endOnTick: false,
                title: {
                    text: optionSelected + '<br/>hazard index'
                },
                labels: {
                    format: '{value}'
                },
            ...
            tooltip: {
                ...
                pointFormat: '<br/><p><span style="color: white">Gap</span></p><p><br/>' +
                    ...
                    optionSelected + ' Hazard: {point.y:,.5f}<br/></p>',
                style: {
                    fontSize: "11px"
                }
            },
