...
function generateChart(fileNamekey) {
    ...
    $.getJSON('https://raw.githubusercontent.com/briefings/sars/develop/explorations/toxicity/warehouse/graphing/respiratory/pollutant/' + fileNamekey + '.json', function (risk) {
